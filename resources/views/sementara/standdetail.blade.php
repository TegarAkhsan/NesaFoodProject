...
<html lang="en">
    ...
    <body>
                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="{{ url('/standdetail') }}" class="nav-item nav-link active">Stand Detail</a>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">Stand Detail</h1>
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item"><a href="#">Pages</a></li>
                <li class="breadcrumb-item active text-white">Stand Detail</li>
            </ol>
        </div>
                        ...
                        <div class="row g-4">
                            <div class="col-lg-6">
                                <div class="border rounded">
                                    <a href="#">
                                        <img src="img/Ayam Teriyaki.jpg" class="img-fluid rounded" alt="Image">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <h4 class="fw-bold mb-3">Ayam Teriyaki</h4>
                                <p class="mb-3">Category: Foods</p>
                                <h5 class="fw-bold mb-3">Rp 12.000</h5>
                                ...
                                <div class="tab-content mb-5">
                                    ...
                                    <div class="tab-pane" id="nav-mission" role="tabpanel" aria-labelledby="nav-mission-tab">
                                        <div class="d-flex">
                                            ...
                                            <div class="">
                                                <p class="mb-2" style="font-size: 14px;">Februari 12, 2025</p>
                                        ...
                                        <div class="d-flex">
                                            <img src="img/avatar.jpg" class="img-fluid rounded-circle p-3" style="width: 100px; height: 100px;" alt="">
                                            <div class="">
                                                <p class="mb-2" style="font-size: 14px;">March 12, 2024</p>
                                                <div class="d-flex justify-content-between">
                                                    <h5>Adinda</h5>
                                                    <div class="d-flex mb-3">
                                                        <i class="fa fa-star text-secondary"></i>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="d-flex flex-column text-start footer-item">
                            <h4 class="text-light mb-3">Stand Info</h4>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="d-flex flex-column text-start footer-item">
                            ...
                            <a class="btn-link" href="">Stand details</a>
