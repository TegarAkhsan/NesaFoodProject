                        ...
                        <div class="navbar-nav mx-auto">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="standDetailDropdown" style="max-height: 300px; overflow-y: auto;" id="standDropdown">
                                    @for($i = 1; $i <= 20; $i++)
                                        <a class="dropdown-item" href="#" data-stand-id="{{ $i }}">Stand {{ $i }}</a>
                                    @endfor
                                </div>
                            </div>
                    ...
                    <div class="col-lg-8 col-xl-9">
                        <div id="standDetail">
                            <div class="text-center mb-5">
                                <img src="{{ $stand->image }}" class="img-fluid rounded" alt="{{ $stand->name }}">
                                                ...
                                                <div class="col-md-6 col-lg-4 col-xl-3">
                                                    <div class="rounded position-relative fruite-item">
                                                        <div class="fruite-img">
                                                            <img src="{{ $food->image }}" class="img-fluid w-100 rounded-top" alt="{{ $food->name }}">
                                                        </div>
                                                        <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                            <h4>{{ $food->name }}</h4>
                                                            <p>{{ $food->description }}</p>
                                                            <div class="d-flex justify-content-between flex-lg-wrap">
                                                                <p class="text-dark fs-5 fw-bold mb-0">Rp {{ $food->price }}</p>
                                        ...
                                        <div class="row g-4">
                                            @foreach($drinks as $drink)
                                                <div class="col-md-6 col-lg-4 col-xl-3">
                                                    <div class="rounded position-relative fruite-item">
                                                        <div class="fruite-img">
                                                            <img src="{{ $drink->image }}" class="img-fluid w-100 rounded-top" alt="{{ $drink->name }}">
                                                        </div>
                                                        <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                            <h4>{{ $drink->name }}</h4>
                                                            <p>{{ $drink->description }}</p>
                                                            <div class="d-flex justify-content-between flex-lg-wrap">
                                                                <p class="text-dark fs-5 fw-bold mb-0">Rp {{ $drink->price }}</p>
                                                                <a href="#" class="btn border border-secondary rounded-pill px-3 text-primary"><i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row g-4">
                                            @foreach($snacks as $snack)
                                                <div class="col-md-6 col-lg-4 col-xl-3">
                                                    <div class="rounded position-relative fruite-item">
                                                        <div class="fruite-img">
                                                            <img src="{{ $snack->image }}" class="img-fluid w-100 rounded-top" alt="{{ $snack->name }}">
                                                        </div>
                                                        <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                            <h4>{{ $snack->name }}</h4>
                                                            <p>{{ $snack->description }}</p>
                                                            <div class="d-flex justify-content-between flex-lg-wrap">
                                                                <p class="text-dark fs-5 fw-bold mb-0">Rp {{ $snack->price }}</p>
                                                                <a href="#" class="btn border border-secondary rounded-pill px-3 text-primary"><i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart</a>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadStandDetail(standId) {
                // Replace with actual AJAX call to load stand detail
